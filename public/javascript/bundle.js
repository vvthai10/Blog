...
exports.updateData = exports.signup = exports.removeBlog = exports.recycleBlog = exports.postBlog = exports.logout = exports.login = exports.deleteBlog = exports.createData = exports.changePhotoUser = exports.changePassword = exports.changeInfoUser = void 0;
...
var createData = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref4) {
    var id, blog, liked, comment, res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = _ref4.id, blog = _ref4.blog, liked = _ref4.liked, comment = _ref4.comment;
  ...
  return function createData(_x7) {
...
var updateData = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(_ref6) {
    var id, blog, liked, comment, valData, res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            id = _ref6.id, blog = _ref6.blog, liked = _ref6.liked, comment = _ref6.comment;
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/interactive/".concat(id, "/").concat(blog),
              data: valData
            });
  ...
  return function updateData(_x8) {
...
var postBlog = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(name, description, mainContent, author) {
    var timeRead, res;
        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              ...
              location.assign("/blog/".concat(res.data.data.newBlog.slug));
            }
  ...
  return function postBlog(_x9, _x10, _x11, _x12) {
...
var removeBlog = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(slug) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/api/v1/blogs/slug/".concat(slug),
              data: {
                deleted: true
              }
            });
  ...
  return function removeBlog(_x13) {
...
var recycleBlog = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(slug) {
    var res;
  ...
  return function recycleBlog(_x14) {
    return _ref10.apply(this, arguments);
  };
}();

exports.recycleBlog = recycleBlog;

var deleteBlog = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(slug) {
    var res;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 7:
            ...
            console.log(_context9.t0.response.data.message);
  ...
  return function deleteBlog(_x15) {
...
var changeInfoUser = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(name, email, id) {
    var res;
  ...
  return function changeInfoUser(_x16, _x17, _x18) {
...
var changePhotoUser = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(formElement, id) {
    var formData, res;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            _context11.next = 4;
            return _axios.default.post("http://127.0.0.1:3000/api/v1/uploads/photoUser", formData, {
              headers: {
                "Content-Type": "multipart/form-data"
              }
            });
  ...
  return function changePhotoUser(_x19, _x20) {
    return _ref13.apply(this, arguments);
  };
}();

exports.changePhotoUser = changePhotoUser;

var changePassword = /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(currentPass, newPass, confirmPass, id) {
    var res;
  ...
  return function changePassword(_x21, _x22, _x23, _x24) {
    return _ref14.apply(this, arguments);
  };
}();

exports.changePassword = changePassword;
},{"axios":"../../node_modules/axios/index.js"}],"formValidation.js":[function(require,module,exports) {
"use strict";
...
function Validator(formSelector, type) {
  var _this = this;
  ...
  var validatorRules = {
    ...
    min: function min(_min) {
      return function (value) {
        return value.length >= _min ? undefined : "Vui l\xF2ng nh\u1EADp \xEDt nh\u1EA5t ".concat(_min, " k\xED t\u1EF1");
      };
    },
    max: function max(_max) {
      return function (value) {
        return value.length <= _max ? undefined : "Vui l\xF2ng nh\u1EADp t\u1ED1i \u0111a ".concat(_max, " k\xED t\u1EF1");
      };
    }
  }; //Lấy ra form element theo id

  var formElement = document.querySelector(formSelector); //Kiểm tra xem form có tồn tại không rồi mới cho phép xử lý
  ...
  formElement.onsubmit = function (event) {
    ...
    if (isValid) {
      ...
      if (type === "login") {
        (0, _login.login)(inputs[0].value, inputs[1].value);
      } // Đăng kí tài khoản mới
      else if (type === "signup") {
        (0, _login.signup)(inputs[0].value, inputs[1].value, inputs[2].value, inputs[3].value);
      } // Tạo blog mới
      else if (type === "postBlog") {
        var divIdUser = document.querySelector(".idUser");
        var id = divIdUser.innerText; // console.log(inputs[0].value, inputs[1].value, inputs[2].value, id);

        (0, _login.postBlog)(inputs[0].value, inputs[1].value, inputs[2].value, id);
      } // Thay đổi các thông tin của user
      else if (type === "changeInfoUser") {
        var _divIdUser = document.querySelector(".idUser");

        var _id = _divIdUser.innerText;
        var nameCurrent = document.querySelector(".nameUserHidden").innerText;
        var emailCurrent = document.querySelector(".emailUserHidden").innerText;
        var inputPath = document.querySelector("#photo.form__upload");

        if (nameCurrent != inputs[0].value || emailCurrent != inputs[1].value) {
          console.log("Chỉnh sửa bài viết");
          (0, _login.changeInfoUser)(inputs[0].value, inputs[1].value, _id);
        } else if (inputPath.value) {
          console.log("Cập nhật hình ảnh..."); // formElement.submit();

          (0, _login.changePhotoUser)(formElement, _id);
        }
      } // Thay đổi mật khẩu của user
      else if (type === "changePassword") {
        var _divIdUser2 = document.querySelector(".idUser");

        var _id2 = _divIdUser2.innerText;
        (0, _login.changePassword)(inputs[0].value, inputs[1].value, inputs[2].value, _id2);
      }
    }
  };
}
},{"./login":"login.js"}],"handleUser.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleBlog = handleBlog;
exports.handleUser = handleUser;
exports.handleWriteReview = handleWriteReview;
...
function handleUser() {
  ...
  var countLikes = document.querySelectorAll(".count-like"); // 1. VIỆC THÍCH BÀI VIẾT
  // 1.1 Khi render ra

  var divCheck = document.querySelector(".active-heart");

  if (divCheck) {
    svgLikes.forEach(function (svg) {
  ...
  if (divLikes) {
    divLikes.forEach(function (like) {
      like.addEventListener("click", function () {
        // Nếu đăng nhập thì mới cho thực hiện thao tác
        if (divIdUser) {
          var liked = false; // Cập nhật trên giao diện
          ...
          if (svgLikes[0].style.color === "rgb(237, 43, 72)") {
            ...
            countLikes.forEach(function (count) {
          ...
          var id = divIdUser.innerText;
          var blog = document.querySelector(".idBlog").innerText; // Kiểm tra đã tồn tại nó trong cơ sở dữ liệu hay chưa

          var hasInData = !liked; // Xem thử có bình luận không

          var allCommend = document.querySelectorAll(".comment__detail--title");
          allCommend.forEach(function (comment) {
...
function handleWriteReview() {
  ...
  var btnDelComment = document.querySelector(".comment__btn--del");
  var btnSendComment = document.querySelector(".comment__btn--take");

  if (inputComment && btnDelComment && btnSendComment) {
    btnDelComment.addEventListener("click", function () {
    ...
    btnSendComment.addEventListener("click", function () {
      if (inputComment.value.trim() !== "") {
        var divIdUser = document.querySelector(".idUser");
        var id = divIdUser.innerText;
        var blog = document.querySelector(".idBlog").innerText;
...
function handleBlog() {
  var btnRemove = document.querySelectorAll("#btn-remove-blog");
  var btnRecycle = document.querySelectorAll("#btn-recycle-blog");
  var btnDeleted = document.querySelectorAll("#btn-deleted-blog");

  if (btnRemove) {
    btnRemove.forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        (0, _login.removeBlog)(e.target.getAttribute("slug"));
      });
    });
  }

  if (btnRecycle) {
    btnRecycle.forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        (0, _login.recycleBlog)(e.target.getAttribute("slug"));
      });
    });
  }

  if (btnDeleted) {
    btnDeleted.forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        (0, _login.deleteBlog)(e.target.getAttribute("slug"));
      });
    });
  }
}
},{"./login":"login.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _handleUser = require("./handleUser");
...
var writeForm = document.querySelector(".form__write");
var changeInfoForm = document.querySelector(".form-change-info");
var changePassword = document.querySelector(".form-change-password"); // const logOutBtn = document.querySelector('.nav__el--logout');
// const userDataForm = document.querySelector('.form-user-data');
// const userPasswordForm = document.querySelector('.form-user-password');
// DELEGATION

if (loginForm) {
  var handleForm = new _formValidation.Validator("#login-form", "login"); // loginForm.addEventListener('submit', e => {
  //   e.preventDefault();
...
if (registerForm) {
  var handleForm = new _formValidation.Validator("#register-form", "signup");
}

if (writeForm) {
  var handleForm = new _formValidation.Validator(".form__write", "postBlog");
}

if (changeInfoForm) {
  var handleForm = new _formValidation.Validator(".form-change-info", "changeInfoUser");
}

if (changePassword) {
  var handleForm = new _formValidation.Validator(".form-change-password", "changePassword");
}

(0, _handleUser.handleUser)();
(0, _handleUser.handleWriteReview)();
(0, _handleUser.handleBlog)();
if (btnLogout) btnLogout.addEventListener("click", _login.logout); // if (userDataForm)
